...
class BRISQUE:
    def __init__(self, url=False):
        ...
        self.url = url
        self.model = os.path.join('C:\\Users\\Asus ZenBook\\vscodeProjects\\vidsim\\brisque\models', "svm.txt")
        self.norm = os.path.join('C:\\Users\\Asus ZenBook\\vscodeProjects\\vidsim\\brisque\models', "normalize.pickle")
    ...
    def calculate_image_quality_score(self, brisque_features):
        ...
        #print(type(scaled_brisque_features))  #  should #print <class 'numpy.ndarray'>
        PRECOMPUTED = 4
        x, idx = svmutil.gen_svm_nodearray(
            scaled_brisque_features,
            isKernel=(self.model.param.kernel_type == PRECOMPUTED))
